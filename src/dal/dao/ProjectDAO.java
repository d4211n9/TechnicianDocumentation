...
public class ProjectDAO implements IProjectDAO {
    ...
    public Project createProject(Project project) throws Exception {
        ...
        String sql = "INSERT INTO Project (Name, Client, Location, Created, SoftDelete, Description, LastModified) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public Project updateProject(Project project) throws Exception {
        ...
        String sql = "UPDATE Project SET Name=?, Location=?, Description=?, LastModified=? WHERE ID=?;";
